...
namespace Diiage2022.Factory_Games.Server.Core
{
    public class Server
    {
        ...
        {
            _services.GameInitialization(_Clients);
            while(true)
            {
                ...
                {                    
                    ...
                    _services.SetPlayerTurn(player[i], _Clients);
                ...
                while (loop)
                {
                    if (client.Client.Connected == true)
                    {
                        if (SocketConnected(client.Client))
                        {
                            ...
                            {
                                int result = _services.AnalyseQuery(communication);
                                if(communication.RequestType == 10)
                                {
                                    _Clients.Remove(client);
                                ...
                                {
                                    case 0:
                                        _services.SendToAll(communication, _Clients);
                                        break;
                                    case 1:
